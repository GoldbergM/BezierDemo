...
public class BezierWaveView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleString = a.getString(
                R.styleable.BezierWaveView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.BezierWaveView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.BezierWaveView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.BezierWaveView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.BezierWaveView_exampleDrawable);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        waveAmplitude = (mHeight - paddingTop - paddingBottom) / 20;
...
//        Log.e("a",rectF.left+"  "+rectF.right);
